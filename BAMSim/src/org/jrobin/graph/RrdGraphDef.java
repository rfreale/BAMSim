...
public class RrdGraphDef implements RrdGraphConstants {
	...
	public void line(String srcName, Paint color, String legend, float width,BasicStroke basicStroke) {
		LegendText legendText = new LegendText(color, legend);
		legendText.setBasicStroke(basicStroke);
		comments.add(legendText);
		Line line=new Line(srcName, color, width);
		line.setBasicStroke(basicStroke);
		plotElements.add(line);
	}
	/**
