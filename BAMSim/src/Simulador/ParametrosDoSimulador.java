...
public class ParametrosDoSimulador {
	public static final int semente= 5020; //Semente utilizada para peseudo-aleat�riedade
	...
	public static final int DebugFile = 0;
	public static final int DebugConsole = 0;
